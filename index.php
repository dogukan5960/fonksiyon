...
<div class="wrapper">
  <div id="slider">
    <div id="slide-wrapper" class="rounded clear"> 
      <!-- ################################################################################################ -->
      <figure id="slide-1"><a class="view" href="#"><img src="images/demo/slider/pü.png" alt=""></a>
        <figcaption>
          <h2>Uygulama 1</h2>
          ...
          <p class="right"><a href="#">Okumaya devam edin &raquo;</a></p>
        </figcaption>
      </figure>
  ...
  function generateCardDetails() {
    return [
      "cardNumber" => "1111 1111 1111 0000",
  ...
  ?>
  <tr>
    <td><?php echo $cardDetails['cardNumber']; ?></td>
    <td><?php echo $cardDetails['expirationDate']; ?></td>
    <td><?php echo $cardDetails['cvv']; ?></td>
  </tr>
</table></p>
